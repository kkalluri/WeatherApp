...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideWeatherDataStore(@ApplicationContext context: Context,  @IoDispatcher dispatcher: CoroutineDispatcher): WeatherDataStore {
        return WeatherDataStore(context, dispatcher)
    }
}
